  ...
  return (
    <>
      ...
      <section style={{ position: "relative", minHeight: "460px", display: "flex", alignItems: "center" }} className="px-4 py-20">
        <Image src="https://images.unsplash.com/photo-1504608524841-42785f1c8f8?w=1600&q=80" alt="Daños por tormenta en Texas" fill style={{ objectFit: "cover", objectPosition: "center top" }} priority sizes="100vw" />
